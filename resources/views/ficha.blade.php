                        ...
                        <form method="POST" class="p-6 flex flex-col" action="/uploudFicha">
                            ...
                            <div class="flex flex-col justify-between">
                                <div class="mb-4 flex flex-col">
                                    ...
                                    <input id="nome-do-personagem" type="text" name="nome_do_personagem"
                                        class="w-full border border-gray-300 p-2 rounded focus:border-red-600 focus:ring-red-600"
                                        placeholder="Digite o nome do seu personagem" required>
                                </div>
        ...
        $(document).ready(function() {
            ...
            request("classes", function(data) {
                data.results.forEach(classes => {
                    $('#classe').append('<option value="' + classes.name + '">' + classes.name +
                        '</option>');
                });
            });
            ...
            request("races", function(data) {
                data.results.forEach(racas => {
                    $('#raca').append('<option value="' + racas.name + '">' + racas.name +
                        '</option>');
                });
            });
            ...
            request("backgrounds", function(data) {
                data.results.forEach(antecendente => {
                    $('#antecedente').append('<option value="' + antecendente.name + '">' +
                        antecendente.name + '</option>');
                });
            });
