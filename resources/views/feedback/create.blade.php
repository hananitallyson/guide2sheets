                ...
                <form method="POST" action="{{ route('feedback.store') }}">
                    ...
                    <div class="mx-auto px-6 py-4 bg-white overflow-hidden shadow sm:rounded-lg">
                        ...
                        <div class="mt-2">
                            ...
                            <input
                                class="block w-full border border-gray-300 p-2 rounded focus:border-red-600 focus:ring-red-600"
                                type="text" name="objetivo_principal" required />
                        </div>
                        <div class="mt-2">
                            <label>Você, como usuário, conseguiu usar as funcionalidades?</label>
                            <input
                                class="block w-full border border-gray-300 p-2 rounded focus:border-red-600 focus:ring-red-600"
                                type="text" name="funcionalidades" required />
                        </div>
                        <div class="mt-2 mb-4">
